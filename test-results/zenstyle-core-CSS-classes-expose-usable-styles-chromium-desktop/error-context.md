...
- Name: zenstyle.spec.mjs >> core CSS classes expose usable styles
- Location: tests\zenstyle.spec.mjs:45:1
...
```yaml
- main [ref=e2]:
  - button "Primary" [ref=e3] [cursor=pointer]
  - article [ref=e4]:
    - generic [ref=e5]: Card
    - generic [ref=e6]: Content
  - generic [ref=e7]: Saved
```
